...
CREATE TABLE sale (
    ...
    INDEX (sale_employee),
    CONSTRAINT fk_employee FOREIGN KEY (sale_employee) REFERENCES employee(id) ON DELETE SET NULL,
    sale_store INT NOT NULL,
    INDEX (sale_store),
    CONSTRAINT fk_store FOREIGN KEY (sale_store) REFERENCES store(id) ON DELETE SET NULL,
    sale_item INT NOT NULL,
    INDEX (sale_item),
    CONSTRAINT fk_item FOREIGN KEY (sale_item) REFERENCES item(id) ON DELETE SET NULL,
    sale_item_two INT,
    INDEX (sale_item_two),
    CONSTRAINT fk_item FOREIGN KEY (sale_item_two) REFERENCES item(id) ON DELETE SET NULL,
    sale_item_three INT,
    INDEX (sale_item_three),
    CONSTRAINT fk_item FOREIGN KEY (sale_item_three) REFERENCES item(id) ON DELETE SET NULL,
    sale_item_four INT,
    INDEX (sale_item_four),
    CONSTRAINT fk_item FOREIGN KEY (sale_item_four) REFERENCES item(id) ON DELETE SET NULL,
    sale_item_five INT,
    INDEX (sale_item_five),
    CONSTRAINT fk_item FOREIGN KEY (sale_item_five) REFERENCES item(id) ON DELETE SET NULL,
